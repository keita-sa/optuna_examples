...
def objective(trial):
    ...
    # Branching out hyperparameters depending on the classifier, whether it is RandomForest or GradientBoosting.
...
# Specifying study_name and storage enable to store the 'study'.（study_name と storage を指定することで study を保存できる）
